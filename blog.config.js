...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '柑柠', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一只普通的仙狐', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://pugua.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '蒲瓜,柑柠,创想时代开发组,创想时代', // 网站关键词 英文逗号隔开
